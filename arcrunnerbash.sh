...
XRSL_FOLDER=$1;CLUSTER=$2;TIMEOUT=$3;PROXY=$4;
...
cd ../$XRSL_RESULTS;
while sleep $TIMEOUT; do arcproxy -S $PROXY;[ $(arcstat -i "../"XRSL_META|grep 'no jobs' | wc -l) > 0 ] && break; arcget -i "../"XRSL_META; done
